if(ver3==0)
    ...
    fa1name = findfileniiorgz([DS dtiQA(1).name filesep 'FA' filesep], 'fa.nii');
    md1name= findfileniiorgz([DS dtiQA(1).name filesep 'MD' filesep], 'md.nii');
    ad1name = findfileniiorgz([DS dtiQA(1).name filesep 'AD' filesep], 'ad.nii');
    rd1name = findfileniiorgz([pwd filesep '..' filesep 'RD' filesep], 'rd.nii' );
